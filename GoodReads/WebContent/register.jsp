					...
					<div class="wrapper">
						<div class="form-inner-cont">
							<div class="forms-26-info">
								...
								<p class="editContent" style="outline: none; cursor: inherit;">Etiam sit amet iaculis nunc, et feugiat enim. Aenean lorem dui, mattis et neque
									ac, viverra dignissim elit. Nunc quis finibus lorem.</p>
							</div>
							<div class="form-right-inf editContent" style="outline: none; cursor: inherit; outline-offset: -2px;">
								<form action="User_masterController" method="post" class="signin-form">
									<div class="forms-gds editContent" style="outline: none; outline-offset: -2px; cursor: inherit;">
										...
										<div class="form-input editContent" style="outline: none; cursor: inherit;"><input type="submit" class="btn btn-primary" name="action" id="action" style="outline: none; cursor: inherit;" value="Signup"></div>
									</div>
